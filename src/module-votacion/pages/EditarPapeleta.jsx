...
export const EditarPapeleta = () => {
	...
	const handleSubmit = () => {
		dispatch(onAddRespuesta({ respuesta, noPapeleta: parseInt(params.noPapeleta, 10) }));
		navigate("/votacion/respuestasPapeletas");
	};

	useEffect(() => {
		if (respuestasPapeletas[noPapeleta] !== undefined) {
			setRespuesta(respuestasPapeletas[params.noPapeleta]);
		}
	}, []);
	return (
		<>
						...
						<Box bgcolor="base.main">
							...
							>
								...
								<Box pt="2rem">
									...
									>
										{papeletaActual.pregunta.subtipo === "escalaDeLikert" ? (
											<>
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
										...
										) : papeletaActual.pregunta.subtipo === "2respuestas" ? (
											<>
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={"Si"}
										...
										) : papeletaActual.pregunta.subtipo === "3respuestas" ? (
											<>
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={"En desacuerdo"}
										...
										) : papeletaActual.pregunta.subtipo === "personalizado1" ? (
											<>
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={papeletaActual.pregunta.opcion1}
														id={1}
														eleccion={respuesta}
														setEleccion={setRespuesta}
													/>
												...
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={papeletaActual.pregunta.opcion2}
														id={2}
														eleccion={respuesta}
														setEleccion={setRespuesta}
													/>
										...
										) : papeletaActual.pregunta.subtipo === "personalizado2" ? (
											<>
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={papeletaActual.pregunta.opcion1}
												...
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={papeletaActual.pregunta.opcion3}
														id={3}
														eleccion={respuesta}
														setEleccion={setRespuesta}
													/>
										...
										) : papeletaActual.pregunta.subtipo === "personalizado3" ? (
											<>
												{" "}
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
												...
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={papeletaActual.pregunta.opcion4}
														id={4}
														eleccion={respuesta}
														setEleccion={setRespuesta}
													/>
												...
												<Grid item xs={12} md={3}>
													<CuadroRespuesta
														respuesta={papeletaActual.pregunta.opcion5}
														id={5}
														eleccion={respuesta}
														setEleccion={setRespuesta}
													/>
										...
										) : papeletaActual.pregunta.tipoRespuesta === "abierta" ? (
											<>
												<TextField
